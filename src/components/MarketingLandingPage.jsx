...
export default function MarketingLandingPage({
  ...
  return <div ref={root} className={`pm-landing ${light ? 'pm-light' : ''} ${paused ? 'pm-motion-paused' : ''}`}>
    ...
    <main>
      ...
      <div className="pm-belief-strip"><span>One clear order.</span><div><span>Three Time-Tested Methods</span><i /><span>Your Work Stays On This Device</span><i /><span>Free, No Account</span></div></div>

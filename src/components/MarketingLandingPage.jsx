...
export default function MarketingLandingPage({
  ...
  return <div ref={root} className={`pm-landing ${light ? 'pm-light' : ''} ${paused ? 'pm-motion-paused' : ''}`}>
    ...
    <main>
      ...
      <div className="pm-belief-strip"><span>Nothing shares first.</span><div><span>Six Decision Methods</span><i /><span>Your Work Stays On Your Device</span><i /><span>No Subscription</span></div></div>

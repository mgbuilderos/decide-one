...
export default function JournalScene({
  ...
  return <div className={`pm-scene ${className}`}>
    {(!ready || failed) && <img className="pm-scene-fallback" src="/renders/decideone-studio-d1.webp" srcSet="/renders/decideone-studio-d1-768.webp 768w, /renders/decideone-studio-d1.webp 1536w" sizes="(max-width: 768px) 100vw, 1536px" width="1536" height="1024" alt="Decide One open at today's page: three priorities, notes, and a week of progress" decoding="async" />}

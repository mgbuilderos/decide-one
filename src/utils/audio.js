...
export const playSound = (type = 'click', isMuted = false) => {
  ...
  try {
    ...
    if (type === 'click') {
      ...
      // Tactile physical book opening: leather creak rustle + paper flutter
      ...
      // Subtle warm mechanical release tone
      osc.type = 'sine';
      ...
      osc.start(now);
      osc.stop(now + 0.08);
    } else if (type === 'book-close') {
      // Satisfying leather notebook closure: low-frequency damping thud + soft air puff
      osc.type = 'sine';

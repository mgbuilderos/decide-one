---
title: Should you do the hardest thing first?
description: Two ordering rules answer this and they disagree, because they optimise for different things. Which one is right depends on what today is actually short of.
slug: should-you-do-the-hardest-thing-first
intent: should i do the hardest task first
published: 2026-09-12
updated: 2026-09-12
sources: FOUNDATIONS.md, FRAMEWORKS.md, VISION.md
links: is-there-a-best-prioritisation-method, top-3-method, how-to-prioritise-tasks
keywords: hardest task first, do the hard thing first, hardest thing first, order of tasks
---
...
**Shortest job first** minimises average waiting time — clear the small things and the queue drains fastest. **Priority scheduling** respects importance over size — do the consequential thing regardless of how long it takes. Neither dominates, and [no ordering rule is best in general](/guides/is-there-a-best-prioritisation-method/).
...
**When it has no deadline and the small things do.** Dated work keeps arriving, and undated work never reaches the front on its own. That is **starvation**, and putting the important thing first is the manual correction for it. [The mechanism is here](/guides/why-important-work-never-gets-done/).
...
**When you genuinely cannot start it.** Hardest-first is advice about ordering, and if the obstacle is that no first action has been named, ordering does not touch it. [That is a different problem with a different fix](/guides/what-to-do-when-you-cannot-start/).
...
If those produce nothing — no single thing the day is for, nothing blocked — then the day's problem is volume rather than order, and the useful move is a limit rather than a sequence: [three things and no fourth](/methods/top-3-method/).
...
- [Is there a best prioritisation method?](/guides/is-there-a-best-prioritisation-method/) — the ordering rules and what each is optimal for
- [Why your important work never gets done](/guides/why-important-work-never-gets-done/) — starvation and the standard fix
- [The Top 3 method](/methods/top-3-method/) — when the problem is volume rather than order

---
title: How to prioritise your tasks
description: Three methods, and how to tell which one today is asking for. A method aimed at the wrong problem feels like a personal failing when it is not.
slug: how-to-prioritise-tasks
intent: how to prioritise tasks
published: 2026-09-12
updated: 2026-09-12
sources: FRAMEWORKS.md, FOUNDATIONS.md, VISION.md
links: top-3-method, ivy-lee-method, urgent-important-matrix, everything-feels-urgent, ivy-lee-vs-top-3, why-to-do-lists-stop-working, how-many-tasks-should-a-day-hold, is-there-a-best-prioritisation-method, littles-law-for-a-working-day, why-important-work-never-gets-done, the-cost-of-switching-tasks, faq, what-to-do-when-you-have-too-much-to-do, plan-your-day-the-night-before, why-you-cannot-finish-anything, how-long-should-a-task-take, what-to-do-when-you-cannot-start, is-multitasking-real, why-deadlines-work, should-you-do-the-hardest-thing-first, how-to-handle-interruptions, do-productivity-systems-work, how-to-say-no-to-more-work, a-task-you-keep-postponing, how-to-plan-a-week, when-your-work-depends-on-others, coming-back-after-time-away, choosing-between-two-important-things, why-priorities-change-by-lunchtime, should-you-schedule-every-hour, conflicting-priorities-from-different-people, how-to-do-a-daily-review, prioritising-when-you-work-for-yourself, how-to-prioritise-a-backlog, is-a-long-to-do-list-bad, why-small-tasks-pile-up, should-you-batch-similar-tasks, when-your-day-is-all-meetings, how-to-decide-what-to-drop, what-a-good-task-looks-like, how-to-prioritise-with-a-team, when-the-day-goes-wrong-early, prioritising-life-not-just-work, what-to-do-with-work-that-repeats
...
| :--- | :--- |
| Too much to do | [The Top 3 method](/methods/top-3-method/) — three lines, no fourth |
| I keep starting things and not finishing them | [The Ivy Lee method](/methods/ivy-lee-method/) — strict order, one at a time |
| Everything feels urgent and I cannot tell what matters | [The urgent/important matrix](/methods/urgent-important-matrix/) — classify before you write |
...
- [Why to-do lists stop working](/guides/why-to-do-lists-stop-working/) — what a plain list does to the order of your day
- [How many tasks should a day hold?](/guides/how-many-tasks-should-a-day-hold/) — what the arithmetic says, and what it does not
- [When everything feels urgent](/guides/everything-feels-urgent/) — the hardest of the three problems
- [Ivy Lee vs Top 3](/guides/ivy-lee-vs-top-3/) — the two most commonly confused methods
